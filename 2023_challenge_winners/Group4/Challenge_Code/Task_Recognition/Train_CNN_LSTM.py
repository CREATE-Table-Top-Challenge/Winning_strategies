...
class Train_CNN_LSTM:
    ...
    def train(self):
        if FLAGS.save_location == "":
            ...
            TrainIndexes, ValIndexes = self.loadData(self.val_fold, self.dataCSVFile)
            if self.balanceCNN:
            ...
            lstmTrainSequences,lstmValSequences = sklearn.model_selection.train_test_split(allSequences,test_size=self.val_fold)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=str,
        default='MS04',
        help='Fold number to be used as validation set'
    )
    parser.add_argument(
        '--data_csv_file',
        type=str,
