...
class Predict_CNN_Transformer:
    def getPredictions(self):
        network = CNN_Transformer.CNN_Transformer()
        if FLAGS.save_location == "":
            ...
            self.networkType = "CNN_Transformer"
            ...
            network.transformer_model.cuda("cuda")
